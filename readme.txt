...
WPDevs Classic Editor & Widgets enables the traditional WordPress classic editor, classic widgets, and the previous version of the Edit Post screen featuring TinyMCE, Meta Boxes, and more. This plugin also supports older plugins that enhance this screen.
...
* By supporting my work, you become a vital part of this incredible journey: [Support & donate](https://www.buymeacoffee.com/wpdevsxyz).
* For WordPress plugin development support visit [WPDevs YouTube Chanel](https://www.youtube.com/@wpdevs)
* Contribute or submit issues on [Github](https://github.com/aminuldeveloper/wpdevs-classic-editor-widgets).
...
1. Writing settings page with WPDevs Classic Editor & Widgets options.
2. Classic Editor in action after disabling Gutenberg.
3. Classic Widgets in action after disabling Gutenberg widgets.
